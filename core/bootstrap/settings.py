...
class ModelSettings:
    chat_path: str = "models/gemma-2b-it.gguf"
    tool_path: str = "models/qwen2.5-7b-instruct.gguf"
    chat_n_ctx: int = 4096
    tool_n_ctx: int = 2048
    ...
    def from_config(cls, config) -> "FridaySettings":
        ...
        return cls(
            ...
            models=ModelSettings(
                chat_path=_get("models.chat.path", "models/gemma-2b-it.gguf"),
                tool_path=_get("models.tool.path", "models/qwen2.5-7b-instruct.gguf"),
