...
class WeatherSkill(Skill):
    ...
    def __init__(self):
        ...
        self._default_city = os.environ.get("DEFAULT_CITY", "Mumbai")
        self.config = None
    ...
    def api_key(self):
        if self.config:
            return self.config.get("skills.weather.api_key", self._api_key)
        return self._api_key
        
    @property
    def default_city(self):
        if self.config:
            return self.config.get("skills.weather.default_city", self._default_city)
